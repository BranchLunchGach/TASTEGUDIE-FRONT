...
const FindIDPWDForm = () => {
  ...
  const sendEmail= (e)=>{
    ...
    if(emailArray.length === 2){
      ...
      if(emailArray.length!==2 || emailArray2.length!==2 || email1 ===""|| email2 ===""||email3 ===""){
          ...
          <StyledFindIDPWDBox>
            <div>
              <StyledForm>
                ...
                <StyledInput type="text" placeholder="가입 시 입력한 이메일" name="userId" id="userId"/>
              </StyledForm>

              <StyledButton type="submit" style={{ marginBottom: "16px" }} onClick={sendEmail}>
                인증번호 보내기
              </StyledButton>
            </div>
            ...
            <div>
              <StyledForm>
                ...
                <StyledInput type="text" placeholder="메일로 받은 인증번호" name="code"id="code"
                ></StyledInput>
              </StyledForm>

              <StyledButton type="submit" onClick={checkCode}>인증하기</StyledButton>
            </div>
            ...
            <div>
              <StyledForm>
                ...
                <StyledInput type="password" placeholder="재설정 할 비밀번호" name="password" id="password"/>
                <StyledP>비밀번호 확인</StyledP>
                <StyledInput type="password" placeholder="재설정 할 비밀번호를 다시 입력"  name="password2" id="password2" onChange={checkPass}/>
                <h3 id="passResultArea">{passResult}</h3>
              </StyledForm>

              <StyledButton type="submit" onClick={resetPassword}>비밀번호 재설정</StyledButton>
            </div>
          </StyledFindIDPWDBox>
        </div>
      </StyledContentBox>
