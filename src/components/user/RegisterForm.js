...
const RegisterForm = () => {
    ...
    const submitJoin = (e)=>{
        ...
        //입력된 값 유효성 검사
        if(user.birthDate !== ""){ //생일 값이 입력되었다면
            ...
            <div className='register-container'>
                <div className='register-sub-container'>
                    ...
                    <form className='register-form'> 
                        <label>
                            <span>*이름</span>
                            <input type='text' id="name" name="name" placeholder='홍길동' onChange={changeValue}/>
                        </label>
                        ...
                        <label>
                            <div style={ isCheckResult ? {color: "red"} : {color: "blue" }}> {idCheckResult}</div>
                        </label>
                        ...
                        <label>
                        <div style={isPassCheckResult ?  {color: "blue"} : {color: "red" } } id="checkResult">{checkResult}</div>
                        </label>
                        ...
                        <label>
                            ...
                            <div className="date-select-container">
                                <select className="date-select" id="year" name="year"  onChange={changeBirth}>
                                    <option>년(4자)</option>
                                    {generateYearOptions()}
                                </select>
                                
                                <select className="date-select" id="month" name="month"  onChange={changeBirth}>
                                    <option>월</option>
                        ...
                        <label>
                            ...
                            <div className="gender-toggle">
                                <input type="radio" id="male" name="gender" value="MAN" checked={true}  onChange={changeValue}/>
